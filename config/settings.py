"""
Django settings for Personal Finance app.
...
SECRET_KEY = os.getenv('DJANGO_SECRET_KEY', 'django-insecure-qa=*o(e5b@#sane%7zhog)%)=+l)l6q60fr2088x7ow7skc%0g')
...
# Use Supabase PostgreSQL database in production, SQLite in development
